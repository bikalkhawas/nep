<?php
   if(isset($_POST['email'])) {
       ...
       $email_to = "inquiry@nepdroid.academy";
       $email_subject = "Enrollment Inquiry";
     ...
     if(strlen($error_message) > 0) {
       ...
       $email_message .= "Course: ".clean_string($course)."\n";
        $email_message .= "Preferred Timing: ".clean_string($timing)."\n";
       $email_message .= "Employment: ".clean_string($employment)."\n";
       $email_message .= "Got Information From: ".clean_string($hear)."\n";
